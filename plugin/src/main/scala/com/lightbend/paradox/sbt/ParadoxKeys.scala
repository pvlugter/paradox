...
trait ParadoxKeys {
  ...
  val paradoxNavigationExpandActive = settingKey[Boolean]("Whether to auto-expand the navigation to the active page.")
  val paradoxNavigationExpandDepth = settingKey[Int]("Determines depth of auto-expanding navigation below the active page.")
